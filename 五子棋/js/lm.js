...
(function() {
    ...
    lm.setCookie = function(name, value, validTime) {
        ...
        document.cookie = 'lm_' + name + "="+ escape(value) + ";expires=" + date.toGMTString();
    };
    /**
     * 获得cookie
     * @param name
    ...
    lm.getCookie = function(name) {
        var arr,reg = new RegExp("(^| )" + 'lm_' + name+"=([^;]*)(;|$)");
    ...
    lm.delCookie = function(name) {
        ...
        if(cval != null)
            document.cookie= 'lm_' + name + "="+cval+";expires="+date.toGMTString();
    };
    /**
    ...
    lm.setItem = function(key, value, validTime)
    {
        if(value && value !== "undefined") {
            if (window.localStorage)  {
                ...
                var date  = new Date();
                date.setTime(date.getTime() + validTime);
                document.cookie = "lm_" + key + "=" + escape(value) + ";expires=" + date.toGMTString();
            }
        }else{
            lm.removeItem(key);
        }
    ...
    lm.getItem = function(key) {
        ...
        if (window.localStorage)
        {
            ...
            var arr = document.cookie.match(new RegExp("(^| )lm_" + key + "=([^;]*)(;|$)"));
            if (arr != null) {
    ...
    lm.delItem = function(key) {
        if (window.localStorage) {
            ...
            if (value != null)  {
                document.cookie = "lm_" + key + "=" + value + ";expires=" + date.toGMTString();
            }
        }
    };
    /**
